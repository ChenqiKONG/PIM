...
def test(args, model):
    save_dir_list = ["./pred_results/Inpainting/PIM_IP/CA/", "./pred_results/Inpainting/PIM_IP/EC/", "./pred_results/Inpainting/PIM_IP/GC/", 
                    "./pred_results/Inpainting/PIM_IP/LB/", "./pred_results/Inpainting/PIM_IP/LR/", "./pred_results/Inpainting/PIM_IP/NS/",
                    "./pred_results/Inpainting/PIM_IP/PM/", "./pred_results/Inpainting/PIM_IP/RN/", "./pred_results/Inpainting/PIM_IP/SG/",
                    "./pred_results/Inpainting/PIM_IP/SH/", "./pred_results/Inpainting/PIM_IP/TE/"]
    test_file_list = ["./csv/test_fake_inpainting/CA.csv", "./csv/test_fake_inpainting/EC.csv", "./csv/test_fake_inpainting/GC.csv",
                    "./csv/test_fake_inpainting/LB.csv", "./csv/test_fake_inpainting/LR.csv", "./csv/test_fake_inpainting/NS.csv",
                    "./csv/test_fake_inpainting/PM.csv", "./csv/test_fake_inpainting/RN.csv", "./csv/test_fake_inpainting/SG.csv",
                    "./csv/test_fake_inpainting/SH.csv", "./csv/test_fake_inpainting/TE.csv"]
