...
def test(args, model):
    save_dir_list = ["./pred_results/AutoSplice/PIM_Autosplice/75/", "./pred_results/AutoSplice/PIM_Autosplice/90/", "./pred_results/AutoSplice/PIM_Autosplice/100/"]
    test_file_list = ["./csv/test_fake_autosplice/Forged_JPEG75.csv", "./csv/test_fake_autosplice/Forged_JPEG90.csv", "./csv/test_fake_autosplice/Forged_JPEG100.csv"]
